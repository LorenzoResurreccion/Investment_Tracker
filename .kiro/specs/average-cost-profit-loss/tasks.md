...
- [x] 1. Database migration and entity changes
  - [x] 1.1 Create Flyway migration V2__add_average_cost.sql
  ...
  - [x] 1.2 Add averageCost field to Investment entity
  ...
  - [x] 1.3 Add averageCost to InvestmentRequest with validation and sentinel pattern
  ...
  - [x] 1.4 Add averageCost to InvestmentResponse record
  ...
  - [x] 1.5 Add averageCost to HoldingDetailResponse record
    - Add `BigDecimal averageCost` parameter to the record
    - Update the `from(Investment)` static factory to include `investment.getAverageCost()`
    - _Requirements: 2.1_

- [x] 2. Back-end service logic for averageCost and weighted average
  - [x] 2.1 Update InvestmentService.createInvestment to persist averageCost
    - Map `request.getAverageCost()` → `investment.setAverageCost(...)` in the create method
    - _Requirements: 1.2, 1.3_

  - [x] 2.2 Update InvestmentService.updateInvestment to handle averageCost with sentinel
  ...
  - [x] 2.3 Add weightedAverageCost to PortfolioSummaryResponse and update getPortfolioSummary
  ...
  - [x] 2.4 Write property test: weighted average cost computation (Property 3)
...
- [x] 3. Checkpoint - Back-end compilation and tests
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Front-end utility functions for profit/loss computation
  - [x] 4.1 Add computeProfitLoss and computeTotalProfitLoss to utils.js
  ...
  - [x] 4.2 Add averageCost validation to utils.js
  ...
  - [x] 4.3 Write property tests for computeProfitLoss (Property 4)
  ...
  - [x] 4.4 Write property tests for computeTotalProfitLoss (Property 5)
  ...
  - [x] 4.5 Write property tests for data point buffer invariant (Property 6)
  ...
  - [x] 4.6 Write property tests for currency formatting (Property 7)
  ...
  - [x] 4.7 Write property tests for averageCost validation (Properties 8, 9, 10)
